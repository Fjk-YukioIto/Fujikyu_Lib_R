...
Public Class InportData
    ...
    ''' <returns></returns>
    Public Shared Function ReadCsv(ByVal FilePath As String, Optional ByVal HasHeader As Boolean = True) As DataTable

        Dim Dt As DataTable = New DataTable

        Try
            If Not System.IO.File.Exists(FilePath) Then
                Windows.Forms.MessageBox.Show("指定されたファイルが見つかりませんでした。", "Error",
